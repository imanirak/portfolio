  ...
  return (
    ...
    <div className="container px-5 py-10 mx-auto text-center lg:px-40">
      <div className="flex flex-col w-full mb-20">
        ...
        <p className="lg:w-2/3 mx-auto leading-relaxed text-zinc-900">
          ...
          <a
            ...
            <div className="flex relative">
              <img
                ...
                src={project.image}
              />
              <div className="px-8 py-10 relative z-10 w-full border-4 border-emerald-800 bg-emerald-900 opacity-0 hover:opacity-100">
